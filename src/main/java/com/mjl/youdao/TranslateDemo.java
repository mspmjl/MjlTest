...
public class TranslateDemo {
    ...
    private static final String APP_KEY = "0ec75d3c706ce6b5";     // 您的应用ID
    private static final String APP_SECRET = "grJm1py6NzgSl1KfyKL7oKlUSmJ9Ksc3";  // 您的应用密钥
    ...
    private static Map<String, String[]> createRequestParams() {
        ...
        String from = "中文";
        String to = "英文";
        String vocabId = "0ec75d3c706ce6b5";
